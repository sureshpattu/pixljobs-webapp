...
Handlebars.registerPartial("job_application", Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <div class=\"panel card_sec js_card_sec\">\n        <div class=\"panel-heading\">\n            <div class=\"row\">\n                <div class=\"col-md-9\">\n                    <a data-toggle=\"collapse\" class=\"panel-title collapsed js_panel_title\"\n                       data-parent=\"#accordion\"\n                       href=\"#collapse_"
    + alias4(((helper = (helper = helpers.index || (data && data.index)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"index","hash":{},"data":data}) : helper)))
    + "\">\n                        <span class=\"highlights\">"
    + ((stack1 = (helpers.truncateText || (depth0 && depth0.truncateText) || alias2).call(alias1,((stack1 = (depth0 != null ? depth0.job : depth0)) != null ? stack1.name : stack1),25,{"name":"truncateText","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "</span>\n                        <span class=\"small_txt\">– "
    + ((stack1 = (helpers.truncateText || (depth0 && depth0.truncateText) || alias2).call(alias1,((stack1 = ((stack1 = (depth0 != null ? depth0.job : depth0)) != null ? stack1.company : stack1)) != null ? stack1.name : stack1),25,{"name":"truncateText","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
